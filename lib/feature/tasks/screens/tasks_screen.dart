...
import 'package:flutter_setup_riverpod/feature/tasks/providers/task_list_provider.dart';import 'package:flutter_setup_riverpod/feature/tasks/models/task.dart';import 'package:flutter_setup_riverpod/shared/widgets/app_checkbox.dart';
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            title: AppText(
              task.title,
              customStyle: task.isCompleted ? const TextStyle(decoration: TextDecoration.lineThrough) : null,
            ),
            subtitle: task.dueDate != null
                ? AppText('Due: ${task.dueDate!.toLocal().toString().split(' ')[0]}',
